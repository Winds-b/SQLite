...
public class MainActivity extends AppCompatActivity {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        String strWord = ((EditText) relativeLayout.findViewById(R.id.txtWord)).getText().toString();
                        String strMeaning = ((EditText) relativeLayout.findViewById(R.id.txtMeaning)).getText().toString();
                        String strSample = ((EditText) relativeLayout.findViewById(R.id.txtSample)).getText().toString();
    ...
    private void UpdateDialog(final String strId, final String strWord, final String strMeaning, final String strSample) {
        final RelativeLayout relativeLayout = (RelativeLayout) getLayoutInflater().inflate(R.layout.insert, null);
        ((EditText) relativeLayout.findViewById(R.id.txtWord)).setText(strWord);
        ((EditText) relativeLayout.findViewById(R.id.txtMeaning)).setText(strMeaning);
        ((EditText) relativeLayout.findViewById(R.id.txtSample)).setText(strSample);
        new AlertDialog.Builder(this)
                .setTitle("修改单词")//标题
                .setView(relativeLayout)//设置视图
                //确定按钮及其动作
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        String strNewWord = ((EditText) relativeLayout.findViewById(R.id.txtWord)).getText().toString();
                        String strNewMeaning = ((EditText) relativeLayout.findViewById(R.id.txtMeaning)).getText().toString();
                        String strNewSample = ((EditText) relativeLayout.findViewById(R.id.txtSample)).getText().toString();
